...
def get_final_param(global_parameters, mask):
    final_parameters = collections.OrderedDict()
    for key in global_parameters:
        if 'mask' not in key:
            final_parameters[key] = global_parameters[key]
        else:
            final_parameters[key] = mask[key]
