...
def split_datasets(dataname, dataset, num_users, data_split_mode):
    data_split = {}
    if data_split_mode == 'iid':
        data_split['train'], label_split = iid(dataname, dataset['train'], num_users)
        data_split['test'], _ = iid(dataname, dataset['test'], num_users)
    elif 'non-iid' in data_split_mode:
        data_split['train'], label_split = non_iid(dataname, dataset['train'], num_users)
        data_split['test'], _ = non_iid(dataname, dataset['test'], num_users, label_split)
    else:
